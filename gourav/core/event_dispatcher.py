"""Gourav event dispatcher"""

# Copyright (C) 2020 - 2023  Gourav Team
#
...
from gourav import plugin, util
from gourav.error import EventDispatchError
from gourav.listener import Listener, ListenerFunc
from gourav.util.misc import StopPropagation
