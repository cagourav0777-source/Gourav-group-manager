...
from gourav.util import types as _types
from gourav.util.async_helper import run_sync

if TYPE_CHECKING:
    from gourav.core import Anjani
        ...
        try:
            ...
            if lang == "en":
                return (
                    ...
                    "__Please contact the bot owner__"
                )
