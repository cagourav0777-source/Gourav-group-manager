...
from gourav import DEFAULT_CONFIG_PATH
...
class Config:
    ...
    GOURAV_API_KEY: Optional[str]
    GOURAV_API_URL: Optional[str]
    ...
    def __init__(self) -> None:
        ...
        self.GOURAV_API_KEY = getenv("GOURAV_API_KEY")
        self.GOURAV_API_URL = getenv("GOURAV_API_URL")
